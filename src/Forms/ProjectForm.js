            ...
            <div className="py-16 px-7 rounded-md bg-red-50">
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
                        ...
                        <div className="md:col-span-2">
                            <input type="text" id="text" name="projectName" placeholder="project name" onChange={handleInput} className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-red-200" />
                        </div>
                        <div className="md:col-span-2">
                            <input type="text" id="text" name="projectTechnologie" placeholder="project technologie" onChange={handleInput} className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-red-200" />
                        </div>
                        <div className="md:col-span-2">
                            <textarea name="projectDecription" rows="5" cols="" placeholder="project description *" onChange={handleInput} className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-red-200"></textarea>
                        </div>
                        <div className="md:col-span-2">
