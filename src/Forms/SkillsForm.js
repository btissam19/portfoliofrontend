            ...
            <div className="py-16 px-7 rounded-md bg-white">
                <form action="" method="POST">
                    ...
                    <div className="md:col-span-2">
                            <label htmlFor="subject" className="float-left block font-normal text-gray-400 text-lg">category :</label>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="md:col-span-2">
                            <input type="email" id="email" name="email" placeholder="technologie name" className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700" />
                        </div>
                        <div className="md:col-span-2">
