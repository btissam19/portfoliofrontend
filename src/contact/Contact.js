...
return(
    <div className="flex items-center justify-center min-h-screen bg-gray-100"> {/* Added a light background for contrast */}
    <form className="w-full max-w-lg space-x-3"> {/* Increased the width slightly for aesthetics */}
